...
Computational design reduces the time and cost of the design process by 
replacing expensive physical prototypes with computer simulated models.
Of course, the simulation must be predictive of real-world performance so that the design changes made by the optimization algorithm 
correspond to improvements to the physical prototype.
