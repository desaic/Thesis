...
Chapter~\ref{ch2:ddfem} starts with the basic computational model for solid elastic materials.
Building on that, we introduce data-drive finite elements or DDFEM.
It is the first method in compute graphics that coarsens non-linear hetereogeneous 
