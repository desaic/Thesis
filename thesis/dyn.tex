...
\begin{figure}
	\includegraphics[width=0.95\textwidth]{figs/coarsening_runtime_sim}
	\centering
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=\columnwidth]{figs/BBI_Figures/Figure_14_BBI}
...
\begin{figure}[h!]
	\includegraphics[width=\columnwidth]{figs/BBI_Figures/Figure_3_BBI}	
...
\begin{figure}[h!]
	\includegraphics[width=0.9\columnwidth]{figs/BBI_Figures/Figure_16_BBI.pdf}	
	\caption{\changed{Comparison of our BBI model to experiment for a 3D-printed cube dropped from an oblique initial orientation.}}
	\label{fig:cube_corner}
\end{figure}

\subsection{Boundary Balancing Impact}
To better understand why DKE projection does such a poor job of resolving impacts in our elastic materials, let us consider again our simple dropped block example in Figure~\ref{fig:BBI_block_compare_all}. We observe that by projecting out just the normal component of displacement along the boundary the DKE method artificially \emph{concentrates} \changed{high stresses} along the elements just inside the boundary. This can be seen in the impact row of Figure~\ref{fig:BBI_block_compare_all}. These concentrated stresses effectively load the near-boundary layers which then spring back, introducing a much too large response as seen in the \changed{final} row of Figure~\ref{fig:BBI_block_compare_all}.
...
\begin{figure}
	\includegraphics[width=\columnwidth]{figs/BBI_Figures/Figure_1_BBI}	
...
\begin{figure}
	\includegraphics[width=\columnwidth]{figs/FlamingoContact}	
