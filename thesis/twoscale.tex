...
\begin{table}
	...
	\begin{table}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=.8\linewidth]{images/gripper_print.png}
		...
		\begin{figure}
			\centering	
			\includegraphics[width=.8\linewidth]{images/bunny_two.png}
		...
		\begin{figure}
			\centering
			\includegraphics[width=.8\linewidth]{images/bridge_three.jpg}
